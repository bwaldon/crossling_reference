...
export default class ExitSurveyLangSpecific extends React.Component {
	...
	exitForm = () => {
		...
		const relationshipOptions = {
			...
			none: "Không có liên hệ / Tôi không biết đối tác của tôi",
			other: "Khác"
		};

		const familiarityRateOptions = {
			daily: "Mổi ngày",
			severalWeekly: "Khoảng vài lần mổi tuần",
			onceWeekly: "Khoảng một lần mổi tuần",
			severalMonthl: "Khoảng vài lần mổi tháng",
			onceMonth: "Khoảng một lần mổi tuần",
			rarely: "Hiếm có",
			never: "Không bao giờ"
		};

		const regionOptions = {
			mien_nam: "Miền Nam Việt Nam",
			mien_bac: "Miền Bắc Việt Nam",
			mien_trung: "Miền Trung Việt Nam",
            usa: "Hoa Kỳ",
			other: "Khác"
		}
			...
			<div dir="auto">
				...
				<div className="pt-form-group">
					...
					<div className="pt-form-group">
						<div className="pt-form-content">
							<b>
								{"Quý vị đã dành nhiều thời gian nhất ở khu vực nào nói tiếng Việt?"}
							</b>
							<HTMLSelect
								name="region"
								id="region"
						...
						<div className="form-line">
							<div>
								<label htmlFor="relationshipOther">
									<b>	Nếu quý vị trả lời "khác" trong câu hỏi trước, vui lòng giải thích:</b>
								</label>
								<input
