...
export default class ExitSurvey extends React.Component {
	...
	exitForm = () => {
		...
		return (
			<div dir="auto">
				<div className="pt-form-content"> //amazon
					<b>
				...
				<form onSubmit={this.handleSubmit}>
					...
					<div className="pt-form-group">
						...
						// number of years lived in a Yugoslav country
						...
						// current language spoken outside of the home
						<div className="form-line">
							<div>
