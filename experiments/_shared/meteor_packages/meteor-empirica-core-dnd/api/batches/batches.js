...
export const batchGroupVisibilityTypes = {
  all: "Anyone with access to the experiment URL may access the batch.",
  private:
    "Batch access granted only to those who pass the batch group name as a URL parameter.",
};
