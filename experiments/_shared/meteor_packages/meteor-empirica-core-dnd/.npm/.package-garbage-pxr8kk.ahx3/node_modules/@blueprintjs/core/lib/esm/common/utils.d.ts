 ...
 * are discarded.
 */
export declare function ensureElement(child: React.ReactChild | undefined, tagName?: keyof JSX.IntrinsicElements): React.ReactElement<any>;
/**
...
export declare function isElementOfType<P = {}>(element: any, ComponentClass: React.ComponentType<P>): element is React.ReactElement<P>;
/**
