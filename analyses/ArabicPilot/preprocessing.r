...
colorTerms <- "
رمادي|رمادية|أخضر|خضراء|خضرا|بنفسجي|ب|اورانج
نفسجية|موف|أبيض|بيضاء|بيضا|أسود|سوداء|سودا|بني|بنية| زهرية|حمراء|حمرا|أصفر|صفراء|صفرا|ذهبي|ذهبية|دهبي|دهبية|برتقالي|برتقالية|فضي|فضية|أزرق|زرقاء|زرقا|وردي|وردية|زهري|أحمر"
sizeTerms <- "كبير |صغير |أكبر |أصغر |ضخم"
nouns <- "أفوكادو|بالون|قبعة|طقية|حزام|دراجة|كرة بلياردو|طابة|ملف|كتاب|سوار|اسوارة| دلو|سطل|فراشة|شمعة|كرسي|تعليقة|معطف|جاكيت|مشط|وسادة|تكاية|جيتار|زهرة|وردة|إطار|برواز|كرة جولف|كرة|مجفف شعر|سشوار|سترة|قميص|كنزة|محرمة|منديل|زينة|فلفل|فليفلة|هاتف|جوال|تلفون|تيلفون|حجرة|سجادة|دعسة|دعاسة|حذاء|صباط|دباسة| مكبس|فنجان شاي |فنجان|كباية|فرشاة أسنان|فرشاة|فرشاية|سلحفاة|سلحفة|سلحفا|كعكة زفاف|كعكة|كيكة|كيك|خيوط|خيطان|صوف
"
