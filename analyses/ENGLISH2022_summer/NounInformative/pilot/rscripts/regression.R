...
d = read_delim("../../../../../data/ENGLISH2022_summer/pilot/data_exp1.tsv", delim = "\t")
...
d_english <- read_delim("../../../../../data/ENGLISH2022_summer/pilot/data_exp1.tsv", delim = "\t")
d_english$Language <- "English"
d_english = d_english %>% 
  mutate(NounMentioned = case_when(typeMentioned == TRUE ~ "noun",
                                   TRUE ~ "no noun"))

d = d_english # might want to eventually add additional languages here
