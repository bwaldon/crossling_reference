...
write_delim(data.frame(d_preManualTypoCorrection %>%
                         select(-target, -images, -listenerImages, -speakerImages,
                                -chat)), 
            "../../../data/BCS/BCSEnglishPilot/preManualTypoCorrection.tsv", delim="\t")
...
d <- read_delim("../../../data/BCS/BCSEnglishPilot/postManualTypoCorrection.tsv", delim = "\t") %>%
...
destinationFolder <- "../../../data/BCS/BCSEnglishPilot"
