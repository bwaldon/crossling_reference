...
BCSProduceBDAandRegressionData <- function(d, destinationFolder) {
  ...
  dd = targets %>%
    ...
    rename(Trial=roundNumber, clickedItem=nameClickedObj, gameid = gameId,
