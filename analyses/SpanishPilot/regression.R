...
d = read_delim("../../data/SpanishPilot/data_exp1.tsv", delim = "\t")
...
# # WITHOUT LANGUAGE COMPARISON 

m.b.oneLang = brm(redUtterance ~ cSufficientProperty*cSceneVariation + (1+cSufficientProperty*cSceneVariation|gameid) + (1+cSufficientProperty*cSceneVariation|clickedType), data=centered %>% filter(Language == "Spanish"), family="bernoulli")

# # WITH LANGUAGE COMPARISON 
